...
Type
  ...
  Public
    ...
    Class Procedure Execute(Const strURL : String);
...
Var
  ...
  Procedure RegisterDockableForm(Const FormClass : TfrmDockableBrowserClass; var FormVar;
...
(**
  ...
  @precon  FormVar is the instance reference and Form Class is the type of class to be created..
  @postcon The form instance is created.

  @param   FormVar   as a TfrmDockableBrowser as a reference
  @param   FormClass as a TfrmDockableBrowserClass as a constant

**)
Procedure CreateDockableForm(var FormVar : TfrmDockableBrowser;
  Const FormClass : TfrmDockableBrowserClass);
Begin
...
(**
  ...
  @param   Form as a TfrmDockableBrowser as a constant

**)
Procedure ShowDockableForm(Const Form : TfrmDockableBrowser);
...
(**
  ...
  @precon  None.
  @postcon If the form exists (which it should) the web browser is asked to render the given URL.

  @param   strURL as a String as a constant

**)
Class Procedure TfrmDockableBrowser.Execute(Const strURL: String);
